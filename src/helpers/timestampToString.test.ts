...
describe("timestampToString function positive testing", () => {
  test("number up to day", () => {
    ...
    expect(timestampToString(1722098765, 1722099355)).toBe("10 м. назад");
  ...
  test("number from day to year", () => {
    expect(timestampToString(1721868255, 1722100855)).toBe("3 д. назад");
    expect(timestampToString(1721499855, 1722100855)).toBe("1 нед. назад");
  ...
  test("number from 1 year", () => {
    expect(timestampToString(1609459200, 1722100855)).toBe("4 г. назад");
    expect(timestampToString(1546300800, 1722100855)).toBe("6 лет назад");
    expect(timestampToString(1514784000, 1722100855)).toBe("7 лет назад");
    expect(timestampToString(1262304000, 1722100855)).toBe("15 лет назад");
  });
});
